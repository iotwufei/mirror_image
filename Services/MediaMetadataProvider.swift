...
actor MediaMetadataProvider {
    ...
    func extractMetadata(for url: URL) async -> (dimensions: CGSize?, duration: TimeInterval?) {
    ...
    private func extractImageMetadata(for url: URL) async -> (CGSize?, TimeInterval?) {
    ...
    private func extractVideoMetadata(for url: URL) async -> (CGSize?, TimeInterval?) {
